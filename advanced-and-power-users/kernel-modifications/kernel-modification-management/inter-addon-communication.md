...
## <mark style="color:$primary;">Prerequisites for inter-addon communication</mark>

In order to be able to communicate with the other addons in your mod, you'll need to get the addon types and to select a type that you'll need to work on. This is to avoid ambiguity that may be caused by calling functions, properties, or fields that may have the same name.

***

## <mark style="color:$primary;">Communication tools</mark>
...
After getting the type, you can now use the communication tools.

<details>

<summary>Calling a publicly accessible addon function</summary>
...
<summary>Getting/Setting a value from/to a property or a field</summary>
...
<summary>Listing functions, properties, and fields</summary>
...
<summary>Listing function and set property parameters</summary>
